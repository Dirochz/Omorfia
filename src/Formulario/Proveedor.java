...
public final class Proveedor extends javax.swing.JFrame {   
    ...
    private void initComponents() {
        ...
        bo_agpo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/proveedor.png"))); // NOI18N
        bo_agpo.setBorder(null);
        bo_agpo.setBorderPainted(false);
        bo_agpo.setContentAreaFilled(false);
        bo_agpo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        bo_agpo.setFocusPainted(false);
        bo_agpo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Proveedor.png"))); // NOI18N
        bo_agpo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/proveedor.png"))); // NOI18N
        bo_agpo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bo_agpoActionPerformed(evt);
            }
        });
        jPanel1.add(bo_agpo, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 70, 200, 150));

        bo_elipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/eliminarprove.png"))); // NOI18N
        bo_elipo.setBorder(null);
        bo_elipo.setBorderPainted(false);
        bo_elipo.setContentAreaFilled(false);
        bo_elipo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        bo_elipo.setFocusPainted(false);
        bo_elipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/EliPro.png"))); // NOI18N
        bo_elipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/eliminarprove.png"))); // NOI18N
        bo_elipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bo_elipoActionPerformed(evt);
            }
        });
        jPanel1.add(bo_elipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 300, 230, 190));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 760, 440));
        ...
        jPanel1.add(mod, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 260, -1, -1));

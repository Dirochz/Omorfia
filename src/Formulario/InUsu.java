...
public final class InUsu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Bo_Agu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/agregarusuario.png"))); // NOI18N
        Bo_Agu.setBorder(null);
        Bo_Agu.setBorderPainted(false);
        Bo_Agu.setContentAreaFilled(false);
        Bo_Agu.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Bo_Agu.setFocusPainted(false);
        Bo_Agu.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/AgUsuario.png"))); // NOI18N
        Bo_Agu.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/agregarusuario.png"))); // NOI18N
        Bo_Agu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Bo_AguActionPerformed(evt);
            }
        });
        jPanel1.add(Bo_Agu, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, 210));

        Bo_Eli.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/eliminarusuario.png"))); // NOI18N
        Bo_Eli.setBorder(null);
        Bo_Eli.setBorderPainted(false);
        Bo_Eli.setContentAreaFilled(false);
        Bo_Eli.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Bo_Eli.setFocusPainted(false);
        Bo_Eli.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/EliUsuario.png"))); // NOI18N
        Bo_Eli.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/eliminarusuario.png"))); // NOI18N
        Bo_Eli.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Bo_EliActionPerformed(evt);
            }
        });
        jPanel1.add(Bo_Eli, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, 230, 200));
        ...
        jPanel1.add(tus, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, 740, -1));

        bo_mod.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        ...
        jPanel1.add(bo_mod, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, -1, -1));

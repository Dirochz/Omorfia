...
public final class AgArt extends javax.swing.JFrame {    
    ...
    private void initComponents() {
        ...
        bo_re.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Regresar.png"))); // NOI18N
        bo_re.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/re.png"))); // NOI18N
        ...
        jPanel1.add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, 110, 60));
        ...
        jPanel1.add(txt_nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 90, 210, -1));
        ...
        jPanel1.add(box_talla, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 200, 40));

        talla.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        talla.setText("Talla:");
        jPanel1.add(talla, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 100, 80, 30));

        Precio.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Precio.setText("Precio: $");
        jPanel1.add(Precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 110, -1));

        Marca.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Marca.setText("Marca:");
        jPanel1.add(Marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 90, 40));

        Des.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Des.setText("Descripción:");
        jPanel1.add(Des, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 290, 150, 40));

        cantidad.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        cantidad.setText("Cantidad:");
        jPanel1.add(cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 160, 120, 40));
        ...
        jPanel1.add(bo_Ace, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 460, -1, -1));
        ...
        imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/2.jpeg"))); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 330, 650, 120));
        ...
        jPanel1.add(ma_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 220, 210, 50));
        ...
        jPanel1.add(spipre, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 160, 190, -1));
        ...
        jPanel1.add(spica, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 160, 120, -1));

        Fondo.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N

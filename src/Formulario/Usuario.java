...
public class Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(ApMa, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, -1, -1));

        Contra.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Contra.setForeground(new java.awt.Color(0, 0, 0));
        Contra.setText("Contraseña:");
        jPanel1.add(Contra, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 210, -1, -1));

        correo.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        correo.setForeground(new java.awt.Color(0, 0, 0));
        correo.setText("Correo:");
        jPanel1.add(correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 110, -1, -1));
        ...
        jPanel1.add(ApPa, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, -1, -1));

        Tipo.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Tipo.setForeground(new java.awt.Color(0, 0, 0));
        Tipo.setText("Tipo:");
        jPanel1.add(Tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, -1, -1));
        ...
        jPanel1.add(txt_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, 240, -1));
        ...
        jPanel1.add(Aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 450, -1, -1));

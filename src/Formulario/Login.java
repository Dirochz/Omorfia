...
public final class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Login.setText("Login");
        jPanel1.add(Login, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, -1, -1));

        Tipo.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        Tipo.setForeground(new java.awt.Color(255, 255, 255));
        Tipo.setText("Tipo:");
        jPanel1.add(Tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, -1, -1));

        Usuario.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        Usuario.setForeground(new java.awt.Color(255, 255, 255));
        Usuario.setText("Usuario:");
        jPanel1.add(Usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 210, -1, -1));
        ...
        jPanel1.add(contra, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, -1, -1));

        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Intelogin.jpeg"))); // NOI18N
        jPanel1.add(Fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, -1, -1));

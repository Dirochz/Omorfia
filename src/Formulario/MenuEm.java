...
public class MenuEm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(bo_tic, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 140, -1, -1));
        ...
        bo_art.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Articulo.png"))); // NOI18N
        bo_art.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/Articulos.png"))); // NOI18N
        bo_art.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bo_artActionPerformed(evt);
            }
        });
        jPanel1.add(bo_art, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, -1, -1));

        Art1.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Art1.setText("Ticket");
        jPanel1.add(Art1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 340, -1, -1));

        Art.setFont(new java.awt.Font("Comic Sans MS", 3, 24)); // NOI18N
        Art.setText("Articulos");
        jPanel1.add(Art, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, -1, -1));

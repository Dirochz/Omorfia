...
public class Inventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bo_reg.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/re.png"))); // NOI18N
        bo_reg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bo_regActionPerformed(evt);
            }
        });
        jPanel1.add(bo_reg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 50));
        ...
        Usuarios.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Usuario.png"))); // NOI18N
        Usuarios.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/Usuario.png"))); // NOI18N
        Usuarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UsuariosActionPerformed(evt);
            }
        });
        jPanel1.add(Usuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 190, 170));
        ...
        Articulos.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Articulo.png"))); // NOI18N
        Articulos.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/Articulos.png"))); // NOI18N
        Articulos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ArticulosActionPerformed(evt);
            }
        });
        jPanel1.add(Articulos, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 160, -1, -1));

        Articulo.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        Articulo.setText("Articulos");
        jPanel1.add(Articulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 340, 110, -1));

        Pro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/proveedor.png"))); // NOI18N
        Pro.setBorder(null);
        ...
        Pro.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenPress/Proveedor.png"))); // NOI18N
        Pro.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagencur/proveedor.png"))); // NOI18N
        Pro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ProActionPerformed(evt);
            }
        });
        jPanel1.add(Pro, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, -1, -1));

        Provedores.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        Provedores.setText("Proveedores");
        jPanel1.add(Provedores, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 330, 150, -1));

        usuario.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        usuario.setText("Usuario");
        jPanel1.add(usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 340, 90, -1));
        ...
        jPanel1.add(Pedidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 420, 240, 50));
        ...
        jPanel1.add(his_ven, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 240, 50));
